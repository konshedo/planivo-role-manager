...
export { default as DepartmentManagement } from '@/components/admin/DepartmentManagement';
export { default as FacilityUserManagement } from '@/components/admin/FacilityUserManagement';
